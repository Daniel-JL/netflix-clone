...
import SliderItemContainer from '../slider-item-container/slider-item-container';
...
const MediaSliderContainer = (
  ...
  const fetchMediaData = async () => {
    ...
    if (genreName === 'trending') {
      ...
      if (data[0].total_pages <= numSlidersLoaded + pagesNeeded) {

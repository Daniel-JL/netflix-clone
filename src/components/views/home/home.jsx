...
import LocoRowGroup from '../../slider/loco-row-group/loco-row-group';
import InfiniteScroll from '../../main-page/infinite-scroll/infinite-scroll';
...
const Home = ({
  ...
  return (
    <HomeContainer>
      {/* Render InfiniteScroll when array with genre data is filled */}
      {genreTypeArrFilled
        && (
        <InfiniteScroll
